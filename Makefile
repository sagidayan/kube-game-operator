...
# kube-game.shiftweek.poc/kube-game-operator-bundle:$VERSION and kube-game.shiftweek.poc/kube-game-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kube-game.shiftweek.poc/kube-game-operator
